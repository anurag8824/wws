            ...
            return (
              <div style={{ border: "1px", borderColor: "gray", borderStyle: "solid" }} className='' key={market._id}>
                ...
                <div className='table-header'>
                  <div style={{ fontSize: "18px", backgroundColor: "#8fd9a8", }} className={`float-left country-name ${classforheadingfirst} min-max`}>
                    <b />Team
                  </div>
                  {/* {(market.oddsType != OddsType.BM) ||
                    market.oddsType == OddsType.BM ? (
                  ...
                  <div style={{ backgroundColor: "#8fd9a8", borderColor: "#8fd9a8", }} className={`back ${classforheading} float-left text-center`}>
                    <b>Lagai</b>
                  </div>
                  <div style={{ backgroundColor: "#8fd9a8", borderColor: "#8fd9a8", }} className={`lay ${classforheading} float-left text-center`}>
                    <b>Khai</b>
                  </div>
                  {/* {  (
                    <>
                    ...
                    .map((runner: IRunner) => {
                      ...
                      return (
                        <div key={runner.selectionId}>
                          ...
                          >
                            <div style={{ backgroundColor: "black" }} className={`  country-name ${classforheadingfirst}`}>
                              <span className='team-name '>
                                <b style={{ color: "white", }}>{runner.runnerName}</b>
                              </span>
                              <p>
