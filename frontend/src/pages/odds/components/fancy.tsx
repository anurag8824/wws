  ...
  fancyheader = (title: string) => {
    return (
      <div className='table-header text-dark'>
        <div style={{fontSize:"18px" ,backgroundColor:"#8fd9a8", }} className={`float-left ${isMobile ? 'bg-theme text-dark' : ' text-dark'} country-name box-6`}>
          {isMobile ? title : ''}<p style={{fontSize:"18px" ,backgroundColor:"#8fd9a8", }} >Session</p>
        </div>
        <div style={{fontSize:"18px" ,backgroundColor:"#8fd9a8", }}className={`${isMobile ? 'box-2' : 'box-1'} float-left lay text-center`}>
          <b>NOT</b>
        </div>
        <div style={{fontSize:"18px" ,backgroundColor:"#8fd9a8", }} className={`${isMobile ? 'box-2' : 'box-1'} float-left back text-center`}>
          <b>YES</b>
        </div>
